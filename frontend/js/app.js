          ...
          <div class="event-body">
            ...
            <div class="event-footer">
              ...
              <div style="display: flex; gap: 8px;">
                <button class="btn btn-secondary view-radar-btn" data-event-id="${evt.id}" title="View on Event Radar Map" style="font-size: 0.8rem; padding: 6px 14px; border-radius: 9999px; display: inline-flex; align-items: center; gap: 5px;">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                  Map
                </button>
                <button class="btn btn-primary register-btn" data-event-id="${evt.id}" style="font-size: 0.8rem; padding: 6px 16px; border-radius: 9999px;">
                  Register & Save
                </button>
              </div>
            </div>
